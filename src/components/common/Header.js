...
const Header = ({
    ...
    const renderTitle = () => {
        if (renderCenterTitle) {
            ...
            if (selectedLangIs == "ar") {
                return (
                    <Image source={icons.ic_logoarabic} style={{ height: 25, resizeMode: 'contain' }} />
                    // <Text
                    //     style={[{
                    //         ...styles.titleStyle,
                ...
                return (
                    <Image source={icons.ic_logoenglish} style={{ height: 25, resizeMode: 'contain' }} />
                );
            }
