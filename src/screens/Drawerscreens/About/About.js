...
const About = ({navigation}) => {
  ...
  const FishingToolsMapped = FishingTools.map((tool, i) => {
    return (
  ...
  return (
    <ImageBackground source={icons.ic_signin_bg} style={styles.image}>
      <SafeAreaView style={styles.content}>
        ...
        />
        <ScrollView>
          <Text style={[styles.text, styles.textItem, styles.title]}>
            Lokahi Fishing - About Us
          </Text>
          <Text style={[styles.text, styles.textItem]}>
            Lokahi Fishing is a communication tool to assist fishermen in having
            more fun sharing knowledge and information to catch more fish with
            less effort! Fishermen can unite in greater numbers by being more
            informed of the news and issues affecting our fisheries and taking
            effective action guided by our team of expert consultants to
            maintain and grow healthy fishing stocks for our generation and
            future generations of our children! Remember, Sustainability means
            "Eat and benefit from well managed fisheries Forever!".
          </Text>
          <Text style={[styles.text, styles.textItem, styles.toolsTitle]}>
            Lokahi Fishing Tools:
          </Text>
          <Text style={[styles.text, styles.textItem]}>
            Data feeds for weather, wind sun, moon, tide, sea surface
