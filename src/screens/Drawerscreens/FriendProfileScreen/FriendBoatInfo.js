...
const FriendBoatInfo = Props => {
  ...
  return (
            ...
            <View style={styles.Container}>
              <View style={styles.rowContent}>
                <Image
                  ...
                  source={
                    boatdata && boatdata.length> 0 && boatdata[0].boat_image 
                ...
                <View style={styles.rowContent2}>
                  <Text style={styles.nameStyle}>{ boatdata && boatdata.length> 0 ? boatdata[0].boat_maker : strings.boatmaker}</Text>
                  <Text style={{
                  ...
                  <Text style={styles.nameStyle}>{ boatdata && boatdata.length> 0  ? boatdata[0].boat_length : strings.boatlength}</Text>
                </View>
              </View>
            </View>
    ...
    justifyContent: 'flex-start'}}>
                ...
                <Text style={styles.textstyle2} numberOfLines={2}>{ boatdata && boatdata.length> 0  ? boatdata[0].home_port : ''}</Text>
              </TouchableOpacity>
            </View>
            <View style={styles.Containertable}>
              <View style={styles.rowContent3}>
                <Text style={styles.textstyle}>{strings.vhfradio}</Text>
                <Image source={ boatdata && boatdata.length> 0  && boatdata[0].VHF_Radio ? icons.ic_donex
            ...
            <View style={styles.Containertable}>
              <View style={styles.rowContent3}>
                ...
                <Image source={boatdata && boatdata.length> 0  &&  boatdata[0].CB_Radio ? icons.ic_donex
                  : icons.ic_not_donex} style={styles.checkIcon} />
              </View>
            </View>
            <View style={styles.Containertable}>
              <View style={styles.rowContent3}>
                ...
                <Image source={boatdata && boatdata.length> 0  &&  boatdata[0].EPIRB ? icons.ic_donex
                  : icons.ic_not_donex} style={styles.checkIcon} />
              </View>
            </View>
            ...
            <View style={styles.Containertable}>
              <View style={styles.rowContent3}>
                ...
                <Image
                  source={boatdata && boatdata.length> 0  &&  boatdata[0].Life_Raft ? icons.ic_donex : icons.ic_not_donex}
            ...
            <View style={styles.Containertable}>
              <View style={styles.rowContent3}>
                ...
                <Image
                  source={boatdata && boatdata.length> 0  &&  boatdata[0].Visual_Distress_Signals ? icons.ic_donex : icons.ic_not_donex}
                  style={styles.checkIcon}
                />
              </View>
            </View>
