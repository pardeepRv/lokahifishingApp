...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.LOGIN_WITH_EMAIL_REQUESTED || actionTypes.SIGNUP_WITH_EMAIL_REQUESTED:
            return { ...state, loading: true };

        case actionTypes.LOGIN_WITH_EMAIL_SUCCEEDED || actionTypes.SIGNUP_WITH_EMAIL_SUCCEEDED:
            return { ...state, loading: false, userDetails: action.userData };

        case actionTypes.LOGIN_WITH_EMAIL_FAIL || actionTypes.SIGNUP_WITH_EMAIL_FAIL:
        ...
        case actionTypes.LOGIN_WITH_PHONE_SUCCEEDED:
            return { ...state, loading: false, showInfo: true, loginViaPhoneMsg: action.responsePhoneApi };
        ...
        case actionTypes.UPDATE_PASSWORD_SUCCEEDED:
            return { ...state, loading: false, updatePasswordMsg: action.payload, userDetails: {}, loginViaPhoneMsg: null };
